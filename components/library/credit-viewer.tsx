...
export function CreditViewer({
  ...
  return (
    <>
      <motion.button className="flex items-center gap-1 border border-secondary rounded-xl py-2 px-4 hover:bg-muted cursor-pointer transition-colors shadow-sm">
        <motion.div>
          <Zap className="text-green-400 size-4" fill="currentColor" />
        </motion.div>
