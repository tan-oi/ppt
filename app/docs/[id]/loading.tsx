    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="flex flex-col items-center gap-6">
        <svg
          ...
          className="h-14 w-14 animate-[deck-breathe_1.6s_ease-in-out_infinite]"
          role="img"
          aria-label="Loading"
        >
          <path
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="relative h-px w-40 overflow-hidden bg-neutral-800/80">
            <div className="absolute inset-y-0 w-1/3 bg-[#FFBF00]/70 animate-[deck-progress_1.6s_ease-in-out_infinite]" />
          </div>
        </div>
      </div>
    </div>
